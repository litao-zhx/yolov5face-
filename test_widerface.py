...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='runs/detect', help='save results1 to project/name')
    parser.add_argument('--name', default='exp', help='save results1 to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    parser.add_argument('--save_folder', default='./widerface_evaluate/widerface_txt/', type=str, help='Dir to save txt results1')
